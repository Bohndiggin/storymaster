...
from PyQt6.QtWidgets import (
    QApplication, QDialog, QWidget, QVBoxLayout, QLineEdit, 
...
from storymaster.view.common.tooltips import (
    LOREKEEPER_TOOLTIPS, LITOGRAPHER_TOOLTIPS, CHARACTER_ARC_TOOLTIPS
)
...
class TestTooltipSystem:
    ...
    def test_lorekeeper_tooltips_exist(self):
        ...
        expected_keys = [
            "actor_first_name", "actor_last_name", "actor_description",
            "location_name", "location_description", "faction_name"
        ]
    ...
    def test_litographer_tooltips_exist(self):
        ...
        # Test some expected tooltips
        expected_keys = [
            "node_label", "node_description", "node_type",
            "plot_title", "plot_description"
        ]
    ...
    def test_character_arc_tooltips_exist(self):
        ...
        # Test some expected tooltips
        expected_keys = [
            "arc_title", "arc_description", "arc_type",
            "arc_point_title", "arc_point_description"
        ]
    ...
    def test_tooltip_content_quality(self):
        ...
        all_tooltips = {**LOREKEEPER_TOOLTIPS, **LITOGRAPHER_TOOLTIPS, **CHARACTER_ARC_TOOLTIPS}
...
class TestContextMenus:
    ...
    def test_spell_check_context_menu_items(self, text_widget):
        ...
        text_widget.spell_checker.get_suggestions = Mock(return_value=["suggestion1", "suggestion2"])
