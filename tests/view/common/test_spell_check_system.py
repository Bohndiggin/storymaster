...
from storymaster.view.common.spellcheck import (
    SpellChecker, SpellCheckTextEdit, SpellCheckLineEdit, 
    SpellCheckHighlighter, BasicWordList, enable_spell_check, get_spell_checker
)
...
class TestSpellChecker:
    ...
    def test_basic_word_list_fallback(self):
        ...
        with patch('storymaster.view.common.spellcheck.SpellChecker._init_enchant', return_value=None), \
             patch('storymaster.view.common.spellcheck.SpellChecker._init_aspell', return_value=None), \
             patch('storymaster.view.common.spellcheck.SpellChecker._init_hunspell', return_value=None):
...
class TestSpellCheckLineEdit:
    ...
    def test_spell_checking_updates_tooltip(self, line_edit):
        ...
        line_edit.spell_checker.is_word_correct = Mock(side_effect=lambda x: x != "misspelled")
...
class TestSpellCheckHighlighter:
    ...
    def test_highlight_block_with_misspellings(self, highlighter):
        ...
        highlighter.spell_checker.is_word_correct = Mock(side_effect=lambda x: x != "misspelled")
