...
from PyQt6.QtWidgets import QTextEdit, QLineEdit, QComboBox, QWidget, QVBoxLayout, QApplication
from PyQt6.QtCore import Qt
from PyQt6.QtGui import QKeyEvent

from storymaster.view.common.custom_widgets import (
    TabNavigationTextEdit, TabNavigationLineEdit, TabNavigationComboBox,
    setup_tab_order, setup_form_tab_navigation, convert_textedit_to_tab_navigation,
    setup_enhanced_tab_navigation, enable_smart_tab_navigation
)
...
class TestTabNavigationTextEdit:
    ...
    def test_backtab_moves_focus_backward(self, text_edit):
        ...
        backtab_event = QKeyEvent(QKeyEvent.Type.KeyPress, Qt.Key.Key_Backtab, Qt.KeyboardModifier.NoModifier)
    ...
    def test_ctrl_tab_inserts_tab(self, text_edit):
        ...
        ctrl_tab_event = QKeyEvent(QKeyEvent.Type.KeyPress, Qt.Key.Key_Tab, Qt.KeyboardModifier.ControlModifier)
    ...
    def test_paste_with_no_text(self, text_edit):
        ...
        with patch('storymaster.view.common.spellcheck.SpellCheckTextEdit.insertFromMimeData') as mock_parent:
            text_edit.insertFromMimeData(mock_mime_data)
