...
from storymaster.model.database.schema.base import Storyline, Setting, StorylineToSetting
...
class TestStorylineSettingsModel:
    ...
    def test_get_settings_for_storyline(self):
        ...
        self.mock_model.get_settings_for_storyline.return_value = [mock_setting1, mock_setting2]
    ...
    def test_get_storylines_for_setting(self):
        ...
        self.mock_model.get_storylines_for_setting.return_value = [mock_storyline1, mock_storyline2]
    ...
    def test_link_storyline_to_setting_success(self):
        ...
        self.mock_model.link_storyline_to_setting.assert_called_once_with(storyline_id=1, setting_id=2)
    ...
    def test_unlink_storyline_from_setting_success(self):
        ...
        result = self.mock_model.unlink_storyline_from_setting(storyline_id=1, setting_id=2)
        
        assert result is True
        self.mock_model.unlink_storyline_from_setting.assert_called_once_with(storyline_id=1, setting_id=2)
    ...
    def test_get_available_settings_for_storyline(self):
        ...
        self.mock_model.get_available_settings_for_storyline.return_value = [mock_setting1, mock_setting2]
...
class TestStorylineSettingsDialog:
    ...
    def test_dialog_initialization(self, qapp):
        ...
        from storymaster.view.common.storyline_settings_dialog import StorylineSettingsDialog
        
        dialog = StorylineSettingsDialog(
            self.mock_model, 
            storyline_id=1, 
            storyline_name="Test Storyline"
        )
    ...
    def test_dialog_loads_data_on_init(self, qapp):
        ...
        self.mock_model.get_available_settings_for_storyline.return_value = [mock_available_setting]
            ...
            with patch.object(dialog, 'load_data') as mock_load_data:
                with patch('PyQt6.QtWidgets.QMessageBox.question') as mock_question:
                    with patch('PyQt6.QtWidgets.QMessageBox.information') as mock_info:
                        ...
                        self.mock_model.unlink_storyline_from_setting.assert_called_once_with(1, 5)
                        mock_load_data.assert_called_once()  # Should refresh data
                        mock_info.assert_called_once()
...
class TestStorylineSettingsIntegration:
    ...
    def test_model_integration_get_settings_for_storyline(self):
        ...
        mock_model.get_settings_for_storyline.return_value = [mock_setting1, mock_setting2]
    ...
    def test_model_integration_link_unlink_workflow(self):
        ...
        # Verify method calls
        mock_model.link_storyline_to_setting.assert_called_once_with(storyline_id=1, setting_id=2)
        mock_model.unlink_storyline_from_setting.assert_called_once_with(storyline_id=1, setting_id=2)
    ...
    def test_model_integration_available_settings_filtering(self):
        ...
        mock_model.get_available_settings_for_storyline.return_value = available_settings
    ...
    def test_storyline_settings_business_logic(self):
        ...
        mock_model.get_settings_for_storyline.return_value = [Mock(id=5, name="New Setting")]
...
class TestStorylineSettingsEdgeCases:
    ...
    def test_database_error_handling(self, qapp):
        ...
        mock_model = Mock()
        mock_model.get_available_settings_for_storyline.side_effect = Exception("Database error")
        mock_model.get_settings_for_storyline.return_value = []
