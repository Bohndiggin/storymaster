...
class TestDatabaseSchemaBasics:
    ...
    def test_node_type_completeness(self):
        ...
        assert expected_types == actual_types, f"Missing node types: {expected_types - actual_types}"
    ...
    def test_model_instantiation(self):
        ...
        # Test Storyline
        storyline = Storyline(name="Test Story", description="A test storyline", user_id=1)
...
class TestDatabaseSchemaIntegration:
    ...
    def test_world_building_completeness(self):
        ...
        for field in essential_location_fields:
            assert hasattr(location, field), f"Location missing essential field: {field}"