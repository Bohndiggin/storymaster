...
class TableVisibilityDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        desc_label = QLabel("Select which tables should be visible in the Lorekeeper database view:")
        ...
        self.tables_list.setToolTip("Check tables to show them in Lorekeeper, uncheck to hide them")
        ...
        info_label = QLabel("ℹ️ System tables and junction tables are automatically hidden and cannot be shown.")
        info_label.setStyleSheet("color: #a0a0a0; font-style: italic; margin-top: 10px;")
        ...
        apply_btn.setStyleSheet("background-color: #5c4a8e; color: white; font-weight: bold;")
    ...
    def load_tables(self):
        ...
        try:
            ...
            for table_name in sorted(all_tables):
                ...
                checkbox.stateChanged.connect(lambda state, table=table_name: self.on_table_toggled(table, state))
    ...
    def apply_changes(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", f"Failed to apply table visibility settings: {e}")
