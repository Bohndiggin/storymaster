...
"")
        ...
        self.lorekeeperHeaderLayout = QtWidgets.QHBoxLayout()
        self.lorekeeperHeaderLayout.setObjectName("lorekeeperHeaderLayout")
        self.pageTitleLabel_2 = QtWidgets.QLabel(parent=self.lorekeeperPage)
        self.pageTitleLabel_2.setObjectName("pageTitleLabel_2")
        self.lorekeeperHeaderLayout.addWidget(self.pageTitleLabel_2)
        self.lorekeeperHeaderLayout.addStretch()
        self.configureTablesButton = QtWidgets.QPushButton(parent=self.lorekeeperPage)
        self.configureTablesButton.setObjectName("configureTablesButton")
        self.lorekeeperHeaderLayout.addWidget(self.configureTablesButton)
        self.verticalLayout_4.addLayout(self.lorekeeperHeaderLayout)
        ...
        self.characterArcsTitleLabel = QtWidgets.QLabel(parent=self.characterArcsPage)
        self.characterArcsTitleLabel.setObjectName("characterArcsTitleLabel")
        self.characterArcsLayout.addWidget(self.characterArcsTitleLabel)
        ...
        self.actionManageStorylineSettings = QtGui.QAction(parent=StorymasterMainWindow)
        self.actionManageStorylineSettings.setObjectName("actionManageStorylineSettings")
        ...
        self.menuSetting.addAction(self.actionManageStorylineSettings)
    ...
    def retranslateUi(self, StorymasterMainWindow):
        ...
        self.configureTablesButton.setText(_translate("StorymasterMainWindow", "Configure Tables"))
        ...
        self.characterArcsTitleLabel.setText(_translate("StorymasterMainWindow", "Character Arcs"))
        ...
        self.actionManageStorylineSettings.setText(_translate("StorymasterMainWindow", "Manage Storylines"))
        self.actionManageStorylineSettings.setToolTip(_translate("StorymasterMainWindow", "Connect settings to storylines"))
