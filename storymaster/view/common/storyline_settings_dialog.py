...
class StorylineSettingsDialog(QDialog):
    ...
    def load_data(self):
        ...
        try:
            ...
            available_settings = self.model.get_available_settings_for_storyline(self.storyline_id)
    ...
    def link_setting(self):
        ...
        try:
            success = self.model.link_storyline_to_setting(self.storyline_id, setting_id)
            if success:
    ...
    def unlink_setting(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                success = self.model.unlink_storyline_from_setting(self.storyline_id, setting_id)
                if success:
                    self.load_data()  # Refresh both lists
                    QMessageBox.information(
                        self, 
