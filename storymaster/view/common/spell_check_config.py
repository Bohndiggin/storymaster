...
from PyQt6.QtWidgets import (
    ...
    QCheckBox, QComboBox, QPushButton, QTextEdit, QLabel,
    QDialogButtonBox, QMessageBox, QLineEdit, QListWidget, 
    QListWidgetItem, QSplitter
)
from PyQt6.QtGui import QFont
from .spellcheck import get_spell_checker
from .theme import get_button_style, get_input_style, get_group_box_style, get_dialog_style, COLORS
...
class SpellCheckConfigDialog(QDialog):
    ...
    def create_settings_panel(self):
        ...
        self.enabled_checkbox.setToolTip("Turn spell checking on or off for all text fields")
        ...
        self.language_combo.addItems([
            "English (US)", "English (UK)", "English (CA)", "English (AU)",
        ...
        self.underline_errors_checkbox.setToolTip("Show red underlines under misspelled words")
        feedback_layout.addWidget(self.underline_errors_checkbox)
        
        self.show_suggestions_checkbox = QCheckBox("Show spelling suggestions in context menu")
        self.show_suggestions_checkbox.setToolTip("Right-click on misspelled words to see suggestions")
        feedback_layout.addWidget(self.show_suggestions_checkbox)
        
        self.tooltip_errors_checkbox = QCheckBox("Show misspellings in tooltips (line edits)")
        self.tooltip_errors_checkbox.setToolTip("Display misspelled words in field tooltips")
    ...
    def create_dictionary_panel(self):
        ...
        self.custom_words_list.setToolTip("Your personal dictionary words - double-click to remove")
        ...
        self.add_word_input.setToolTip("Type a word and click Add to include it in your dictionary")
        ...
        self.creative_words_checkbox.setToolTip("Include specialized vocabulary for fiction writing")
    ...
    def add_custom_word(self):
        ...
        if word and word.isalpha():
            ...
            self.load_custom_words()
            QMessageBox.information(self, "Word Added", f"'{word}' added to your dictionary.")
        elif word:
            QMessageBox.warning(self, "Invalid Word", "Please enter a single word with only letters.")
    ...
    def apply_settings(self):
        ...
        QMessageBox.information(self, "Settings Applied", "Spell check settings have been updated.")
