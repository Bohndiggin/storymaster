...
class ArcPointDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        if self.arc_point:
            ...
            self.ui.emotionalStateEdit.setPlainText(self.arc_point.emotional_state or "")
            self.ui.relationshipsEdit.setPlainText(self.arc_point.character_relationships or "")
