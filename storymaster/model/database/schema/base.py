...
class User(BaseTable):
    ...
    lorekeeper_groups: Mapped[list["LorekeeperGroup"]] = relationship(back_populates="user")
...
class Project(BaseTable):
    ...
    user_id: Mapped[int] = mapped_column(Integer, ForeignKey("user.id"), nullable=False, name="user_id")

    user: Mapped["User"] = relationship(back_populates="projects")
    project_to_groups: Mapped[list["ProjectToGroup"]] = relationship(back_populates="project")
    litography_nodes: Mapped[list["LitographyNode"]] = relationship(back_populates="project")
    litography_notes: Mapped[list["LitographyNotes"]] = relationship(back_populates="project")
    litography_plots: Mapped[list["LitographyPlot"]] = relationship(back_populates="project")
    litography_arcs: Mapped[list["LitographyArc"]] = relationship(back_populates="project")
...
class LorekeeperGroup(BaseTable):
    ...
    project_to_group: Mapped[list["ProjectToGroup"]] = relationship(back_populates="group")
    ...
    actor_relations: Mapped[list["ActorAOnBRelations"]] = relationship(back_populates="group")
    skills: Mapped[list["Skills"]] = relationship(back_populates="group")
    actor_to_skills: Mapped[list["ActorToSkills"]] = relationship(back_populates="group")
    factions: Mapped[list["Faction"]] = relationship(back_populates="group")
    faction_relations: Mapped[list["FactionAOnBRelations"]] = relationship(back_populates="group")
    faction_members: Mapped[list["FactionMembers"]] = relationship(back_populates="group")
    locations: Mapped[list["Location"]] = relationship(back_populates="group")
    location_to_factions: Mapped[list["LocationToFaction"]] = relationship(back_populates="group")
    location_dungeons: Mapped[list["LocationDungeon"]] = relationship(back_populates="group")
    location_cities: Mapped[list["LocationCity"]] = relationship(back_populates="group")
    location_city_districts: Mapped[list["LocationCityDistricts"]] = relationship(back_populates="group")
    residents: Mapped[list["Resident"]] = relationship(back_populates="group")
    location_flora_fauna: Mapped[list["LocationFloraFauna"]] = relationship(back_populates="group")
    ...
    history_locations: Mapped[list["HistoryLocation"]] = relationship(back_populates="group")
    history_factions: Mapped[list["HistoryFaction"]] = relationship(back_populates="group")
    objects: Mapped[list["Object_"]] = relationship(back_populates="group")
    history_objects: Mapped[list["HistoryObject"]] = relationship(back_populates="group")
    ...
    history_world_data: Mapped[list["HistoryWorldData"]] = relationship(back_populates="group")
...
class ProjectToGroup(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, Identity(), nullable=False, primary_key=True, name="id")
    project_id: Mapped[int] = mapped_column(Integer, ForeignKey("project.id"), nullable=False, name="project_id")
    group_id: Mapped[int] = mapped_column(Integer, ForeignKey("lorekeeper_group.id"), nullable=False, name="group_id")
...
class LitographyNode(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, Identity(), nullable=False, primary_key=True, name="id")
    node_type: Mapped[NodeType] = mapped_column(Enum(NodeType, values_callable=lambda obj: [e.value for e in obj]), nullable=False, name="node_type")
    node_height: Mapped[float] = mapped_column(Float, nullable=False, name="node_height")
    previous_node: Mapped[int | None] = mapped_column(Integer, nullable=True, name="previous_node")
    next_node: Mapped[int | None] = mapped_column(Integer, nullable=True, name="next_node")
    project_id: Mapped[int] = mapped_column(Integer, ForeignKey("project.id"), nullable=False, name="project_id")
...
class LitographyNotes(BaseTable):
    ...
    description: Mapped[str | None] = mapped_column(Text, nullable=True, name="description")
    note_type: Mapped[NoteType] = mapped_column(Enum(NoteType, values_callable=lambda obj: [e.value for e in obj]), nullable=False, name="note_type")
    linked_node_id: Mapped[int] = mapped_column(Integer, ForeignKey("litography_node.id"), nullable=False, name="linked_node")
    project_id: Mapped[int] = mapped_column(Integer, ForeignKey("project.id"), nullable=False, name="project_id")
...
class LitographyPlot(BaseTable):
    ...
    plot_sections: Mapped[list["LitographyPlotSection"]] = relationship(back_populates="section_plot")
...
class LitographyNodeToPlotSection(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, Identity(), nullable=False, primary_key=True, name="id")
    node_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_node.id"), name="node_id")
    litography_plot_section_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_plot_section.id"), name="litography_plot_section_id")
...
class LitographyArc(BaseTable):
    ...
    id: Mapped[int | None] = mapped_column(Integer, Identity(), nullable=True, primary_key=True, name="id")
    project_id: Mapped[int] = mapped_column(Integer, ForeignKey("project.id"), nullable=False, name="project_id")
...
class Class_(BaseTable):
    ...
    class_description: Mapped[str | None] = mapped_column(Text, name="class_description")
    group_id: Mapped[int] = mapped_column(Integer, ForeignKey("lorekeeper_group.id"), nullable=False, name="group_id")
...
class Background(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, Identity(), nullable=False, primary_key=True)
...
class Actor(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, Identity(), primary_key=True, nullable=False, name="id")
    ...
    class_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("class.id"), nullable=True, name="class_id")
    actor_level: Mapped[int | None] = mapped_column(Integer, nullable=True, name="actor_level")
    background_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("background.id"), nullable=True, name="background_id")
    ...
    race_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("race.id"), nullable=True, name="race_id")
    sub_race_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("sub_race.id"), nullable=True, name="sub_race_id")
    alignment: Mapped[str | None] = mapped_column(String(2), nullable=True, name="alignment")
    strength: Mapped[int | None] = mapped_column(Integer, nullable=True, name="strength")
    dexterity: Mapped[int | None] = mapped_column(Integer, nullable=True, name="dexterity")
    constitution: Mapped[int | None] = mapped_column(Integer, nullable=True, name="constitution")
    intelligence: Mapped[int | None] = mapped_column(Integer, nullable=True, name="intelligence")
    wisdom: Mapped[int | None] = mapped_column(Integer, nullable=True, name="wisdom")
    charisma: Mapped[int | None] = mapped_column(Integer, nullable=True, name="charisma")
    ...
    actor_a_relations: Mapped[list["ActorAOnBRelations"]] = relationship(foreign_keys="ActorAOnBRelations.actor_a_id", back_populates="actor_a")
    actor_b_relations: Mapped[list["ActorAOnBRelations"]] = relationship(foreign_keys="ActorAOnBRelations.actor_b_id", back_populates="actor_b")
...
class ActorAOnBRelations(BaseTable):
    ...
    actor_a: Mapped["Actor"] = relationship(foreign_keys=[actor_a_id], back_populates="actor_a_relations")
    actor_b: Mapped["Actor"] = relationship(foreign_keys=[actor_b_id], back_populates="actor_b_relations")
...
class Faction(BaseTable):
    ...
    faction_a_relations: Mapped[list["FactionAOnBRelations"]] = relationship(foreign_keys="FactionAOnBRelations.faction_a_id", back_populates="faction_a")
    faction_b_relations: Mapped[list["FactionAOnBRelations"]] = relationship(foreign_keys="FactionAOnBRelations.faction_b_id", back_populates="faction_b")
...
class FactionAOnBRelations(BaseTable):
    ...
    faction_a: Mapped["Faction"] = relationship(foreign_keys=[faction_a_id], back_populates="faction_a_relations")
    faction_b: Mapped["Faction"] = relationship(foreign_keys=[faction_b_id], back_populates="faction_b_relations")
...
class Location(BaseTable):
    ...
    location_flora_fauna: Mapped[list["LocationFloraFauna"]] = relationship(back_populates="location_")
    ...
    city_districts: Mapped[list["LocationCityDistricts"]] = relationship(foreign_keys="LocationCityDistricts.location_id", back_populates="location")
    districts_in_city: Mapped[list["LocationCityDistricts"]] = relationship(foreign_keys="LocationCityDistricts.district_id", back_populates="district")
...
class LocationToFaction(BaseTable):
    ...
    group: Mapped["LorekeeperGroup"] = relationship(back_populates="location_to_factions")
...
class LocationCityDistricts(BaseTable):
    ...
    location: Mapped["Location"] = relationship(foreign_keys=[location_id], back_populates="city_districts")
    district: Mapped["Location"] = relationship(foreign_keys=[district_id], back_populates="districts_in_city")
    group: Mapped["LorekeeperGroup"] = relationship(back_populates="location_city_districts")
...
class LocationFloraFauna(BaseTable):
    ...
    group: Mapped["LorekeeperGroup"] = relationship(back_populates="location_flora_fauna")
...
class LitographyNoteToActor(BaseTable):
    ...
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
...
class LitographyNoteToBackground(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    background_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("background.id"), name="background_id")
...
class LitographyNoteToFaction(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    faction_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("faction.id"), name="faction_id")
...
class LitographyNoteToLocation(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    location_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("location_.id"), name="location_id")
...
class LitographyNoteToHistory(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    history_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("history.id"), name="history_id")
...
class LitographyNoteToObject(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    object_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("object_.id"), name="object_id")
...
class LitographyNoteToWorldData(BaseTable):
    ...
    id: Mapped[int] = mapped_column(Integer, nullable=False, primary_key=True, name="id")
    note_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_notes.id"), name="note_id")
    world_data_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("world_data.id"), name="world_data_id")
...
class ArcToNode(BaseTable):
    ...
    id: Mapped[int | None] = mapped_column(Integer, nullable=True, primary_key=True, name="id")
    node_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_node.id"), name="node_id")
    arc_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("litography_arc.id"), name="arc_id")
...
class ArcToActor(BaseTable):
    ...
    id: Mapped[int | None] = mapped_column(Integer, nullable=True, primary_key=True, name="id")
    actor_id: Mapped[int] = mapped_column(Integer, ForeignKey("actor.id"), nullable=False, name="actor_id")
    arc_id: Mapped[int] = mapped_column(Integer, ForeignKey("litography_arc.id"), nullable=False, name="arc_id")
