...
class Actor(Base):
    ...
    background_id = Column(Integer, ForeignKey('background.id'), nullable=True, name='background_id')
    ...
    sub_race_id = Column(Integer, ForeignKey('sub_race.id'), nullable=True, name='sub_race_id')
