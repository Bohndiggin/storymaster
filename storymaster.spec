...
hiddenimports = [
    ...
    # FastAPI and sync server dependencies
    'fastapi',
    ...
    'storymaster.sync_server.server_manager',
    'storymaster.sync_server.config',
    'storymaster.sync_server.database',
    'storymaster.sync_server.auth',
    'storymaster.sync_server.models',
    'storymaster.sync_server.sync_engine',
